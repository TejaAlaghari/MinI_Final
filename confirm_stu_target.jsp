...
<head>
	...
	<script type = "text/javascript">
		...
		function create_select(game, ind)
		{
			...
			option.setAttribute("class","select-style");		    
		...
		function fill_table()
		{
			...
			for(var ind = 0; ind < count; ind++)
			{
				...
				td.setAttribute("class", "select-style");
				tr.appendChild(td);
				...
				playerUname.setAttribute("class", "select-style");
				...
				playerName.setAttribute("class", "select-style");
				...
				if(view == 0)
				{
					...
					radioButton.setAttribute("class", "select-style");
				...
				else
				{
					...
					*/
					...
					playerStatus.setAttribute("class", "select-style");
...
<body data-spy="scroll" data-target="#site-nav">
    <nav id="site-nav" class="navbar navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-items">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!-- navigation menu -->
                    <li class="active"><a data-scroll href="#playerc">PlayerInformation</a></li>
	 ...
	 <header id="site-header" class="site-header valign-center"> 
		...
		<section id="playerc" class="section form">
		<div class="container">
               
			<header>
				<h1 ><span>Confirm student</span></h1>
            </header>   
			<form  method= "post" accept-charset= "utf-8">
				<p class="contact">
				<table  cellspacing= "5" cellpadding= "5" id= "here" align= "center">

					<p class="contact"><tr id= "gtr1" cellspacing= "15" cellpadding= "5"></p>

					<script type= "text/javascript">
						
						create_select("gam1", 1);"<br>"
					...
					&nbsp;&nbsp;<td id= "gtd1_3">&nbsp;
					<input class="buttom" align="center" style="width: 300px height: 300px"; type= "submit" name="submit" value= "Get Players"/>
	...
	<p class="contact"><table align= "center" id= "here" width= "50%" style= "border-collapse: collapse;">
